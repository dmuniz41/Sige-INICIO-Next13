...
export const LoginScreen = () => {
  return (
    ...
    />
      ...
      <form className="grid w-[380px] p-[30px] h-[300px] border-t-[4px] border-solid border-t-primary-500 font-bold bg-white rounded-[5px] shadow-xl">
        ...
        <input
          ...
          id="input_password"
        />
        <button className="text-white font-bold pointer bg-primary-500 rounded-md mt-2 w-full h-[50px] border-none transition-all hover:bg-primary-600">ENTRAR</button>
      </form>
